...
> **Note:** Các `TBD` phải được BA xác nhận với stakeholder trước khi chuyển
> thành Business Rule chính thức. Không nên tự đưa ra giá trị cụ thể vì điều
> đó có thể làm thay đổi nghiệp vụ thực tế của doanh nghiệp.
